...
<form action="profile_agence" method="POST" enctype="multipart/form-data">
    @csrf 
    <div class="profile">
    ...
    <div class="formulaire_profile_agence">
        ...
        <table class="formulaire">
            ...
            <tr>
                ...
                <td>
                    <input name="NomEntreprise"class="@error('NomEntreprise') is_invalid @enderror" type="nomber">
                    @error('NomEntreprise')
                    <div class="invalid-feedback" style="color: red;font-size:12px;">
                       <p> {{$errors->first('NomEntreprise')}}!</p>
                    </div>
                    @enderror
                </td>
            </tr>
            <tr>
                <td>Numero de Siren</td>
                <td>
                    <input name="NumeroSiren"class="@error('NumeroSiren') is_invalid @enderror" type="nomber">
                    @error('NumeroSiren')
                    <div class="invalid-feedback" style="color: red;font-size:12px;">
                       <p> {{$errors->first('NumeroSiren')}}!</p>
                    </div>
                    @enderror
                </td>
            </tr>
            <tr>
                <td>Site Web</td>
                <td>
                    <input name="Siteweb"class="@error('Siteweb') is_invalid @enderror" type="texte">
                    @error('Siteweb')
                    <div class="invalid-feedback" style="color: red;font-size:12px;">
            ...
            <button type="submit" class="enregistreA">Enregistre</button>
        </table>        
    </div>
</form>
